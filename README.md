...
К редактору схем:
- Добавление в SVG элемента connector для связи фигур по их id [source & target по аналогии с drawio](https://github.com/bpmbpm/SemanticBPM/blob/main/implementations/drawio/principles.md). Проблема [подробнее](https://github.com/bpmbpm/SemanticBPM/blob/main/docs/SVG/connector/README.md) ;
