...
### Г. Вычисление id
На начальном этапе id процесса** будем вычислять по названию процесса путем замены пробелов на “_”, например, «Разработка схемы» даст id = Разработка_схемы. 
...
- MetaModelDia, включающая формат схемы процесса: заголовок процесса и составные части процесса (элементы), которые при наличие дублей их кодируют через символ "#".
