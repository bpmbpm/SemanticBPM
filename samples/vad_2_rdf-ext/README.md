...
Пример loadTrig_SPARQL.mjs и process1.trig так и не заработал корректно.  
...
### Итог
npm install rdf-ext rdf-fetch rdf-parser-n3 sparqljs - перебор для загрузки TriG и  SPARQL-запроса. Видимо стоит использовать что-то иное.    
