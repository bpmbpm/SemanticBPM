...
const store = rdf.graph(); // Создаем граф для хранения данных
// const ttlFilePath = path.resolve(__dirname, '../Process_1.ttl'); // Формруем путь к Process_1.ttl из папки на уровень выше
const ttlFilePath = path.resolve(__dirname, 'Process_1.ttl'); 
const ttlData = fs.readFileSync(ttlFilePath, 'utf8').toString(); // Загружаем TTL файл Process_1.ttl
